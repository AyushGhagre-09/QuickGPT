  ...
  return (
    ...
    >
              ...
              <div>
                <p className="truncate w-full">
                  {chat.messages.length > 0
                    ? chat.messages[0].content.slice(0, 12)
                    : chat.name}
                </p>
                <p className="text-xs text-gray-500 dark:text-[#B1AC60)]">
      ...
      <div
        ...
        className="flex items-center gap-2 p-3 mt-4 border border-gray-300 dark:border:border-white/15 rounded-md cursor-pointer hover:scale-103 transition-all"
      >
        <img
